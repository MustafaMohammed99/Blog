        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-white">
                <a class="navbar-brand order-1" href="index.html">
                    <img class="img-fluid" src="{{ asset('assets/front/logo.png') }}" alt="النهضة نت" width="100px">
                </a>
                ...
                <div class="order-2 order-lg-3 d-flex align-items-center">
                    ...
                    <form action="{{ route('home.search') }}" method="get" class="search-bar">
                        <x-form.input name="s" placeholder="ابحث هنا...." type="search"  :value="request('s')" />

                    </form>
                    {{-- <form action="{{ route('home.search') }}" method="get" class="search-bar">
                        <x-form.input name="title" placeholder="ابحث هنا...." class="mx-2" :value="request('title')" />
