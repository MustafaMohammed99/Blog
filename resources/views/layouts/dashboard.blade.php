...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click"
        ...
        <div class="navbar-container d-flex content">
            <ul class="nav navbar-nav align-items-center ml-auto">
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                        ...
                        aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder"></span>
                            {{--                            class="user-name font-weight-bolder">{{Auth::user()->name}}</span> --}}
                        </div>
                        <span class="avatar">

                            <img class="round" src="" {{--                             src="{{asset(Auth::user()->image_path)??asset('assets/dashboard/app-assets/images/portrait/small/avatar-s-11.jpg')}}" --}} alt="avatar" height="40"
                                width="40">
                    ...
                    <a class="navbar-brand" {{--                   href="{{route('adminHome.index')}}" --}}>
                        <span class="brand-logo">
                            <img class="round" style="border: #0D7091"
                                src="{{ asset('assets/dashboard/app-assets/images/pages/logo.jpg') }}" alt="avatar"
                                height="40" width="40">
                        </span>
                ...
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                                ...
                                <div class="col-sm-6">
                                    <ol class="breadcrumb m-0 float-sm-lift">
                                        @section('breadcrumb')
    ...
    <script src="{{ asset('assets/dashboard/app-assets/vendors/js/tables/datatable/datatables.bootstrap4.min.js') }}">
    </script>
    <script src="{{ asset('assets/dashboard/app-assets/vendors/js/tables/datatable/dataTables.responsive.min.js') }}">
    </script>
    <script src="{{ asset('assets/dashboard/app-assets/vendors/js/tables/datatable/responsive.bootstrap.min.js') }}">
    </script>
    <!-- END: Page Vendor JS-->
